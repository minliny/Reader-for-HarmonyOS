import svgPaths from "./svg-a52rtn1jk6"
import { imgGroup } from "./svg-e7z7l"
import imgPaperLayer from "./99d77078d4edc59bf6fc0f8d5cf678d7361665e5.png"
type AppearanceSelectOptionProps = {
  className?: string
  propValue?: string
}

function AppearanceSelectOption({
  className,
  propValue = "选项",
}: AppearanceSelectOptionProps) {
  return (
    <div
      className={className || "h-[36px] relative w-[88px]"}
      data-name="Appearance/Select/Option"
    >
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[10px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Noto_Sans_SC:Regular',sans-serif] font-normal leading-[normal] min-w-px relative text-[#41484c] text-[12px]">
            {propValue}
          </p>
        </div>
      </div>
...
type AppearanceSelectSelectedProps = {
  className?: string
  propValue?: string
}

function AppearanceSelectSelected({
  className,
  propValue = "选中项",
}: AppearanceSelectSelectedProps) {
  return (
    <div
      className={
        className || "bg-[rgba(238,230,219,0.64)] h-[36px] relative w-[88px]"
      }
      data-name="Appearance/Select/Selected"
    >
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[4px] items-center pl-[10px] pr-[6px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Noto_Sans_SC:Bold',sans-serif] font-bold leading-[14.4px] min-w-px relative text-[#1f3528] text-[12px]">
            {propValue}
          </p>
          <div className="flex items-center justify-center relative shrink-0">
            <div className="flex-none rotate-180">
              <div
                className="h-[4px] overflow-clip relative w-[8px]"
                data-name="reader_chevron_down"
              >
                <div
                  className="absolute bottom-0 contents left-1/4 right-1/4 top-0"
                  style={{ containerType: "size" }}
                  data-name="Clip path group"
                >
                  <div
                    className="absolute flex inset-[37.5%] items-center justify-center"
                    style={{ containerType: "size" }}
                  >
                    <div className="flex-none h-[100cqw] rotate-90 w-[100cqh]">
                      <div
                        className="mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-1px_-1.5px] mask-size-[4px_4px] relative size-full"
                        style={{ maskImage: `url("${imgGroup}")` }}
                        data-name="Group"
                      >
                        <div className="absolute inset-[-7.29%_-14.58%]">
                          <svg
                            className="block size-full"
                            fill="none"
                            height="2.29167"
                            preserveAspectRatio="none"
                            viewBox="0 0 1.29167 2.29167"
                            width="1.29167"
                          >
                            <g id="Group">
                              <path
                                d={svgPaths.p13bb6f00}
                                id="Vector"
                                stroke="#41484C"
                                strokeLinecap="round"
...
function AppearanceSelect({
  ...
  return (
    <div
      className={
        className ||
        "bg-[rgba(255,248,239,0.82)] relative rounded-[6px] w-[88px]"
      }
    >
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start relative size-full">
          <AppearanceSelectSelected
            className="bg-[rgba(238,230,219,0.64)] h-[36px] relative shrink-0 w-full"
            propValue="原文"
          />
      ...
      <div
        aria-hidden
        className="absolute border border-[#c1c7cd] border-solid inset-0 pointer-events-none rounded-[6px]"
      />
    </div>
  )
}
type AppearanceStepperProps = {
  className?: string
  propValue?: string
  propValue1?: string
}

function AppearanceStepper({
  className,
  propValue = "字号",
  propValue1 = "18px",
}: AppearanceStepperProps) {
  return (
    <div
      className={className || "h-[34px] relative w-[312px]"}
      data-name="Appearance/Stepper"
    >
      <p className="[word-break:break-word] absolute font-['Noto_Sans_SC:Medium',sans-serif] font-medium leading-[14px] left-0 text-[#332c25] text-[10px] top-[10px] whitespace-nowrap">
        {propValue}
      </p>
      <div
        className="absolute bg-[rgba(238,230,219,0.64)] h-[28px] left-[184px] overflow-clip rounded-[8px] top-[3px] w-[24px]"
        data-name="Decrease"
      >
        <p className="[word-break:break-word] absolute font-['Inter:Bold',sans-serif] font-bold leading-[14px] left-[10px] not-italic text-[#332c25] text-[10px] top-[7px] whitespace-nowrap">
          −
        </p>
      </div>
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Bold',sans-serif] font-bold leading-[14px] left-[240px] not-italic text-[#332c25] text-[10px] text-center top-[10px] w-[48px]">
        {propValue1}
      </p>
      <div
        className="absolute bg-[rgba(238,230,219,0.64)] h-[28px] left-[264px] overflow-clip rounded-[8px] top-[3px] w-[24px]"
        data-name="Increase"
      >
        <p className="[word-break:break-word] absolute font-['Inter:Bold',sans-serif] font-bold leading-[14px] left-[9px] not-italic text-[#332c25] text-[10px] top-[7px] whitespace-nowrap">
          +
        </p>
      </div>
      <div
        className="absolute bg-[rgba(255,255,255,0)] left-[174px] size-[44px] top-[-5px]"
        data-name="HitTarget/Decrease"
      />
      <div
        className="absolute bg-[rgba(255,255,255,0)] left-[254px] size-[44px] top-[-5px]"
        data-name="HitTarget/Increase"
      />
    </div>
  )
}
type AppearanceSelectTriggerProps = {
  className?: string
  propValue?: string
}

function AppearanceSelectTrigger({
  className,
  propValue = "当前值",
}: AppearanceSelectTriggerProps) {
  return (
    <div
      className={
        className || "bg-[#fffdf8] h-[32px] relative rounded-[10px] w-[88px]"
      }
      data-name="Appearance/Select/Trigger"
    >
      <div
        aria-hidden
        className="absolute border border-[rgba(155,132,102,0.18)] border-solid inset-0 pointer-events-none rounded-[10px]"
      />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[12px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Noto_Sans_SC:Bold',sans-serif] font-bold leading-[normal] min-w-px overflow-hidden relative text-[#332c25] text-[12px] text-ellipsis whitespace-nowrap">
            {propValue}
          </p>
          <div
            className="h-[4px] overflow-clip relative shrink-0 w-[8px]"
            data-name="reader_chevron_down"
          >
            <div
              className="absolute bottom-0 contents left-1/4 right-1/4 top-0"
...
function SwatchDay() {
  return (
    <div
      className="absolute bg-white border-[0.5px] border-[rgba(180,166,151,0.3)] border-solid h-[18px] left-[8.25px] rounded-[6px] top-[2px] w-[46px]"
...
function SwatchWarm() {
  return (
    <div
      className="absolute bg-[#fbf0df] border-[0.5px] border-[rgba(180,166,151,0.3)] border-solid h-[18px] left-[8.25px] rounded-[6px] top-[2px] w-[46px]"
...
function SwatchNight() {
  return (
    <div
      className="absolute bg-[#26231f] border-[0.5px] border-[rgba(180,166,151,0.3)] border-solid h-[18px] left-[8.25px] rounded-[6px] top-[2px] w-[46px]"
...
function SwatchWarmNight() {
  return (
    <div
      className="absolute bg-[#302922] border-[0.5px] border-[rgba(180,166,151,0.3)] border-solid h-[18px] left-[8.25px] rounded-[6px] top-[2px] w-[46px]"
...
function SwatchPaper() {
  return (
    <div
      className="absolute bg-[#f5ead8] border-2 border-[#2f6373] border-solid h-[18px] left-[8.25px] rounded-[6px] top-[2px] w-[46px]"
...
function SwatchGreen() {
  return (
    <div
      className="absolute bg-[#e7f0e2] border-[0.5px] border-[rgba(180,166,151,0.3)] border-solid h-[18px] left-[8.25px] rounded-[6px] top-[2px] w-[46px]"
...
function SwatchPaperNight() {
  return (
    <div
      className="absolute bg-[#34302b] border-[0.5px] border-[rgba(180,166,151,0.3)] border-solid h-[18px] left-[8.25px] rounded-[6px] top-[2px] w-[46px]"
...
function SwatchGreenNight() {
  return (
    <div
      className="absolute bg-[#263129] border-[0.5px] border-[rgba(180,166,151,0.3)] border-solid h-[18px] left-[8.25px] rounded-[6px] top-[2px] w-[46px]"
...
function Header() {
  return (
    <div className="h-[36px] relative shrink-0 w-[312px]" data-name="Header">
      <div
        className="[word-break:break-word] absolute h-[20px] left-0 top-0 w-[312px]"
...
function SelectField() {
  return (
    <div
      className="bg-[rgba(255,252,248,0.62)] content-stretch flex h-[44px] items-center justify-between px-[9px] relative rounded-[6px] shrink-0 w-[312px]"
      data-name="SelectField/缩进"
    >
      <div
        aria-hidden
        className="absolute border border-[rgba(155,132,102,0.18)] border-solid inset-0 pointer-events-none rounded-[6px]"
      />
      <p className="[word-break:break-word] font-['Noto_Sans_SC:Bold',sans-serif] font-bold leading-[14px] relative shrink-0 text-[#332c25] text-[10px] whitespace-nowrap">
        缩进
      </p>
      <AppearanceSelectTrigger
        className="bg-[#fffdf8] h-[32px] relative rounded-[10px] shrink-0 w-[88px]"
        propValue="无"
      />
    </div>
  )
...
function SelectList() {
  return (
    <div
      className="content-stretch flex flex-col gap-[8px] h-[200px] items-start relative shrink-0 w-[312px]"
...
function StepperList() {
  return (
    <div
      className="content-stretch flex flex-col gap-[2px] h-[144px] items-start pb-[2px] relative rounded-[8px] shrink-0 w-[312px]"
      data-name="StepperList"
    >
      <AppearanceStepper className="h-[34px] relative shrink-0 w-[312px]" />
      <AppearanceStepper
        className="h-[34px] relative shrink-0 w-[312px]"
        propValue="行距"
        propValue1="1.96"
      />
      <AppearanceStepper
...
function Component1() {
  return (
    <div
      className="absolute blur-[0px] content-stretch flex flex-col gap-[8px] h-[406px] items-start left-[11px] pt-[10px] px-[2px] top-[367px] w-[316px]"
      data-name="排版库 / 当前实现"
    >
      <Header />
      <SelectList />
...
function ContentViewportAppearance() {
  return (
    ...
    >
      ...
      <Component1 />
      <AppearanceSelect className="absolute bg-[rgba(255,248,239,0.82)] left-[228px] rounded-[6px] top-[479px] w-[88px]" />
    </div>
  )
}
