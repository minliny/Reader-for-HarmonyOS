...
if (readerBuilderSdkAvailable) {
  ...
  const resultTreeMembers = [...contentScrollMethods, 'resultsBody', 'resultRow', 'resultSnippet',
  ...
  const settingsBuilderMembers = ['p', 'geometry', 'groupWidth', 'label', 'bar', 'choice', 'child', 'segmentRow', 'toggleRow',
  ...
  Object.assign(owner, { motionProgress: 0, availableWidth: 286, interactionEnabled: true,
    ...motionProps, clipEndpointWidth: -1, clipFullRects: [], clipQuickRects: [],
