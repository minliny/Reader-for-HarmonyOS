...
assert.match(frameMethod, /this\.layout\.fullPanelWidth, this\.layout\.fullPanelHeight, this\.layout\.dockBottomGap/);
...
assert.match(shared, /enableScrollInteraction\(this\.fullInput\(\) && this\.draggedFontId === '' && this\.openSelect === ''\)/);
