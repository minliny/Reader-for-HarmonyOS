...
assert.match(overlay,
  /linearGradient\(\{[\s\S]*readerAppColor\('app\.SettingsSelectOverlay\.phoneSheet\.linearGradient\.FFFAF7F2', this\.appThemeScheme\)[\s\S]*readerAppColor\('app\.SettingsSelectOverlay\.phoneSheet\.linearGradient\.FFF5F0E8', this\.appThemeScheme\)[\s\S]*borderRadius\(\{ topLeft: 18, topRight: 18 \}\)/,
...
assert.match(overlay, /app\.media\.settings_select_check/,
