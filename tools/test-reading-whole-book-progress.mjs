...
assert.match(experienceSource, /wholeBookProgressPercent\([\s\S]*?this\.desiredChapterOffset/,
...
assert.match(experienceSource, /if \(metrics !== undefined\) \{[\s\S]*wholeBookProgressPercent/,
