...
const icons = [
  ...
  icon('bookshelf_compass_filled', 'Filled/Discover', '#FFFAF4', 'bookshelf discover active'),
  ...
  icon('bookshelf_library_filled', 'Filled/Bookshelf', '#FFFAF4', 'bookshelf library active navigation'),
  ...
  icon('bookshelf_rss_filled', 'Filled/Rss', '#FFFAF4', 'bookshelf rss active navigation'),
  ...
  icon('bookshelf_section_search', 'Search', '#756F69', 'bookshelf section search'),
  icon('bookshelf_settings', 'Settings', '#756F69', 'bookshelf settings inactive'),
  icon('bookshelf_settings_filled', 'Filled/Settings', '#FFFAF4', 'bookshelf settings active navigation'),
