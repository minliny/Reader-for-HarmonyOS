...
assert.match(experience,
  /private applyReaderWindowPolicy\(snapshot: ReaderSettingsSnapshot\): Promise<void> \{\s*return ReaderWindowCoordinator\.requestReaderWindowPolicy\(this\.windowPolicyFor\(snapshot\)\);/,
