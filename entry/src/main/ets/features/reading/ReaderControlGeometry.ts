...
// Both endpoint centers align with the rail cap centers.
export const READER_CONTROL_BRIGHTNESS_ICON_TOP =
  (READER_CONTROL_BRIGHTNESS_RAIL_WIDTH - READER_CONTROL_BRIGHTNESS_ICON_SIZE) / 2;
...
export const READER_CONTROL_BRIGHTNESS_TRACK_HEIGHT = READER_CONTROL_BRIGHTNESS_RAIL_HEIGHT -
  READER_CONTROL_BRIGHTNESS_RAIL_WIDTH - READER_CONTROL_BRIGHTNESS_ICON_SIZE / 2 -
  READER_CONTROL_BRIGHTNESS_AUTO_PILL_SIZE / 2 - 2 * READER_CONTROL_BRIGHTNESS_CONTROL_GAP;
